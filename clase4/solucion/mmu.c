...
paddr_t mmu_unmap_page(uint32_t cr3, vaddr_t virt) {
  ...
  if ((pd[directoryIdx].attrs & 0x001) != 0x000){ //Si esta presente...
    pt_entry_t *pt = (pt_entry_t*) (pd[directoryIdx].pt << 12);
