...
void screen_draw_layout(void) {
  screen_draw_box(0, 0, 50, 80,' ', 0x4E);
  // screen_draw_box(0,0, 49, 79, 0x4E);
  print("Juan Ignacio Martinez 558/18",0,15,0x4E);
  print("Federico Barrena 236/18",0,16,0x4E);
  print("Franco Crego 345/16",0,17,0x4E);
}
